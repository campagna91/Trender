...
INSERT INTO `ActorUsecases` VALUES ('Utente','UC1'),('Utente','UC1.1'),('Utente','UC1.2'),('Utente','UC1.3'),('Utente','UC1.5'),('Utente','UC1.6'),('Utente','UC1.7'),('Utente autenticato','UC1'),('Utente autenticato','UC1.4'),('Utente autenticato','UC1.8');
...
INSERT INTO `RequirementsUsecases` VALUES ('R0F1.2.1','UC1.1'),('R0F2','UC1'),('R0F2','UC1.2'),('R0F2.1','UC1.2'),('R0F2.2','UC1.2'),('R0F2.2.2','UC1.2'),('R0F2.3','UC1.6'),('R0F2.3.1','UC1.6'),('R0F2.3.2','UC1.6'),('R0F2.3.3','UC1.6'),('R0F3','UC1'),('R0F3','UC1.3'),('R0F3.1','UC1.3'),('R0F3.2','UC1.3'),('R0F3.3','UC1.7'),('R0F3.3.1','UC1.7'),('R0F3.3.2','UC1.7'),('R0F3.3.3','UC1.7'),('R0F4.1','UC1.4'),('R0F4.2','UC1.4'),('R0F4.3','UC1.4'),('R0F4.3.1','UC1.4'),('R0F4.4','UC1.4'),('R0F4.4.1','UC1.4'),('R0P2.2.1','UC1.2'),('R0P2.3.4','UC1.5'),('R0V1','UC1'),('R0V1','UC1.1'),('R0V1.1','UC1.1'),('R0V1.1.1','UC1.1'),('R0V1.1.1','UC1.2'),('R0V1.1.1','UC1.3'),('R0V1.1.1','UC1.4'),('R0V1.1.2','UC1.1'),('R0V1.2','UC1.1'),('R0V1.3','UC1.1'),('R0V1.3.1','UC1.1'),('R0V1.3.2','UC1.1'),('R0V1.4.1','UC1.5'),('R0V1.4.2','UC1.5'),('R0V1.4.3','UC1.5'),('R0V1.4.4','UC1.5'),('R0V1.5','UC1.1'),('R0V1.5.1','UC1.1'),('R1F4','UC1'),('R1F4','UC1.4'),('R1V1.4','UC1.5');
...
INSERT INTO `Usecases` VALUES ('UC1',NULL,'Caso d\'uso pubblico','un utente puÃ² registrarsi, autenticarsi o ritirare le chiavi dei dispositivi ad esso associati','','il servizio Ã¨ acceduto dall\'utente tramite un browser supportato','il sistema predisponde l\'interfaccia d\'autenticazione','','','','l\'utente decide di non intraprendere nessun\'azione e chiude il browser e/o cambia pagina'),('UC1.1','UC1','Registrazione','un utente puÃ² iscriversi al servizio','','l\'utente ha richiesto la pagina di registrazione tramite l\'apposita interfaccia','i dati dell\'utente vengono memorizzati nel sistema e l\'utente puÃ² autenticarsi','','','','l\'utente abbandona l\'interfaccia di registrazione'),('UC1.2','UC1','Autenticazione','un utente puÃ² autenticarsi nel sistema','','l\'utente ha deciso di autenticarsi nel sistema','il sistema autentica le credenziali utente e se corrette mostra la pagina principale','','','','l\'utente decide abbandonare l\'interfaccia di autenticazione'),('UC1.3','UC1','Ritiro delle chiavi','un utente puÃ² richiedere il ritiro di tutte le chiavi attualmente rilasciate dal sistema ed associate ai dispositivi dell\'utente','','l\'utente ha richiesto il ritiro delle chiavi dall\'apposita interfaccia','il sistema ritira le chiavi per tutti i dispositivi all\'utente associati e condivide una nuova chiave con l\'utente','','','','l\'utente decide di abbandonare l\'interfaccia di ritiro delle chiavi'),('UC1.4','UC1','Cambio password','un utente autenticato puÃ² cambiare la propria password','','l\'utente si Ã¨ autenticato nel sistema ed ha richiesto l\'apposita interfaccia','il sistema convalida i dati richiesti e cambia la password all\'utente associata','','','',''),('UC1.5','UC1','Visualizzazione errori registrazione','l\'utente visualizza gli errori relativi ai dati errati inseriti in fase di registrazione. Tale circostanza Ã¨ da attribuirsi ad:\n\\begin{itemize}\n\\item indirizzo email giÃ  presente nel sistema\n\\item indirizzo email non del formato corretto\n\\item password troppo corta\n\\item password e password di conferma diverse\n\\item pin calcolato diverso da quello ricevuto\n\\end{itemize}','extension','l\'utente ha inserito i dati nell\'apposita interfaccia di registrazione ed ha confermato l\'operazione','il sistema non registra l\'utente e mostra l\'errore a schermo','','','',''),('UC1.6','UC1','Visualizzazione errori autenticazione','l\'utente visualizza gli errori relativi ai dati errati inseriti in fase di autenticazione','extension','l\'utente ha inserito i dati tramite l\'apposita interfaccia di autenticazione ed ha confermato l\'operazione','il sistema non autentica l\'utente e restituisce un errore a schermo','','','',''),('UC1.7','UC1','Visualizzazione errori ritiro chiavi','l\'utente visualizza gli errori relativi ai dati errati inseriti in fase di ritiro delle chiavi','extension','l\'utente ha inserito i dati richiesti nell\'apposita interfaccia di ritiro delle chiavi','il sistema non ritira nessuna chiave e restituisce un errore a schermo','','','',''),('UC1.8','UC1','Visualizzazione errore cambio password','l\'utente visualizza gli errori relativi ai dati errati inseriti in fase di cambio della password','','l\'utente ha inserito i dati richiesti nell\'apposita interfaccia per il cambio della password','Il sistema non cambia la password dell\'utente e restituisce un errore a schermo','','','','');
...
-- Dump completed on 2015-11-17 16:59:28
