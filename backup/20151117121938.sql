...
INSERT INTO `ActorUsecases` VALUES ('Utente','UC1'),('Utente','UC1.1'),('Utente','UC1.3'),('Utente autenticato','UC1');
...
INSERT INTO `Usecases` VALUES ('UC1',NULL,'Caso d\'uso pubblico','un utente puÃ² registrarsi, autenticarsi o ritirare le chiavi dei dispositivi ad esso associati','','il servizio Ã¨ acceduto dall\'utente tramite un browser supportato','il sistema predisponde l\'interfaccia d\'autenticazione','','','','l\'utente decide di non intraprendere nessun\'azione e chiude il browser e/o cambia pagina'),('UC1.1','UC1','Registrazione','un utente puÃ² iscriversi al servizio','','l\'utente ha richiesto la pagina di registrazione','i dati dell\'utente vengono memorizzati nel sistema e l\'utente puÃ² autenticarsi','','','',''),('UC1.2','UC1','Autenticazione','un utente puÃ² autenticarsi nel sistema','','l\'utente ha deciso di autenticarsi nel sistema','il sistema autentica le credenziali utente e se corrette mostra la pagina principale','','','','l\'utente decide di non autenticarsi ed abbandona l\'interfaccia'),('UC1.3','UC1','Ritiro delle chiavi','un utente puÃ² richiedere il ritiro di tutte le chiavi attualmente rilasciate dal sistema ed associate ai dispositivi dell\'utente','','l\'utente ha richiesto il ritiro delle chiavi dall\'apposita interfaccia','il sistema ritira le chiavi per tutti i dispositivi all\'utente associati e condivide una nuova chiave con l\'utente','','','',''),('UC1.4','UC1','Cambio password','un utente autenticato puÃ² cambiare la propria password','','l\'utente si Ã¨ autenticato nel sistema ed ha richiesto l\'apposita interfaccia','il sistema convalida i dati richiesti e cambia la password all\'utente associata','','','','');
...
-- Dump completed on 2015-11-17 12:19:38
