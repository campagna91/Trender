...
INSERT INTO `Requirements` VALUES ('R0F1.2.1','R0V1.2','La password deve avere una lunghezza di minimo 8 caratteri','Interno','notSatisfied'),('R0F2',NULL,'Il sistema permette all\'utente di autenticarsi nel sistema','Interno','notSatisfied'),('R0F3',NULL,'Il sistema permette all\'utente di ritirare le chiavi dei dispositivi ad esso associati','Interno','notSatisfied'),('R0V1',NULL,'Il sistema permette all\'utente di registrarsi nel sistema','Interno','notSatisfied'),('R0V1.1','R0V1','Il sistema richiede per la registrazione l\'inserimento di un\'email','Interno','notSatisfied'),('R0V1.1.1','R0V1.1','L\'email deve avere un formato valido ovvero deve contenere una sequenza di lettere nella forma prima\'@\'seconda dove prima corrisponde all\'utente e seconda il dominio di appartenenza','Interno','notSatisfied'),('R0V1.1.2','R0V1.1','L\'email deve essere univocamente riconosciuta dal sistema','Interno','notSatisfied'),('R0V1.2','R0V1','Il sistema richiede per la registrazione l\'inserimento di una password','Interno','notSatisfied'),('R0V1.3','R0V1','Il sistema richiede per la registrazione l\'inserimento di un pin','RFC4226','notSatisfied'),('R0V1.3.1','R0V1.3','Il pin deve avere una lunghezza minima di 6 caratteri','RFC4226','notSatisfied'),('R0V1.4.1','R1V1.4','Il sistema interrompe la procedura di registrazione se l\'email inserita non soddisfa i requisiti','Interno','notSatisfied'),('R0V1.4.2','R1V1.4','Il sistema interrompe la procedura di registrazione se la password non rispetta i requisiti','Interno','notSatisfied'),('R0V1.4.3','R1V1.4','Il sistema interrompe la procedura di registrazione se la password di conferma non soddisfa i requisiti','Interno','notSatisfied'),('R0V1.4.4','R1V1.4','Il sistema interrompe la procedura di registrazione se il pin inviato differisce da quello calcolato sul server','RFC4226','notSatisfied'),('R0V1.5','R0V1','Il sistema richiede per la registrazione l\'inserimento di una password di conferma','Interno','notSatisfied'),('R0V1.5.1','R0V1.5','La password di conferma deve essere identica alla password inserita','Interno','notSatisfied'),('R1F4',NULL,'Il sistema permette all\'utente autenticato di cambiare la propria password','Interno','notSatisfied'),('R1V1.4','R0V1','Il sistema avvisa l\'utente che durante la procedura di registrazione  avvenuto un errore','Interno','notSatisfied');
...
-- Dump completed on 2015-11-17 11:19:55
